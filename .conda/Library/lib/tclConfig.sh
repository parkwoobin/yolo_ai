...
# installed.
TCL_PREFIX='d:/VS_Code/yolo_ai/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/VS_Code/yolo_ai/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/VS_Code/yolo_ai/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/VS_Code/yolo_ai/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/VS_Code/yolo_ai/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/VS_Code/yolo_ai/.conda\Library\lib\tclstub86.lib'
